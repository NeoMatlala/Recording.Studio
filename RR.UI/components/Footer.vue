        ...
        <div class="w-full max-w-screen-xl mx-auto md:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                    ...
                    <li>
                        <a href="#" class="hover:underline me-4 md:me-6">Studios</a>
                    </li>
                    <li>
            ...
            <span class="block font-light mt-5 text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">R&RStudios™</a>. All Rights Reserved.</span>
        </div>
    </footer>
</template>