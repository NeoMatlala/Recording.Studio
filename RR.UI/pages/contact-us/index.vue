            ...
            <div class="rounded-lg bg-slate-100 text-slate-600 w-full md:w-1/2 p-5 md:p-0 md:py-16 h-auto flex justify-center items-center">
                <div class="w-full md:w-2/3 md:mx-auto">
                    ...
                    <div class="flex justify-start items-center gap-5">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-facebook w-4 h-4 hover:text-black" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-instagram w-4 h-4 hover:text-black" viewBox="0 0 16 16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi w-4 h-4 hover:text-black bi-linkedin" viewBox="0 0 16 16">
            ...
            <div class="rounded-lg w-full md:w-1/2 h-full">
                <form class="mt-5">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="message" rows="4" class="block p-2.5 placeholder-slate-300 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Type your message here..."></textarea>
                    </div>
                    
                    <button type="submit" class="text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">Submit</button>
                </form>
