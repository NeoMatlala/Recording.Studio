        ...
        <div class="mt-5 max-w-[95%] mx-auto">
            ...
            <div class="mt-10 flex justify-start items-center gap-8">
                <NuxtLink to="/bookings" class="block w-[250px] p-10 bg-white border border-gray-200 rounded-lg hover:bg-gray-100">
                    <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-900">4</h5>
                    <p class="font-normal text-gray-700">Active Bookings</p>
                </NuxtLink>
                <NuxtLink to="/employees" class="block w-[250px] p-10 bg-white border border-gray-200 rounded-lg hover:bg-gray-100">
                ...
                <NuxtLink to="/payments" class="block w-[250px] p-10 bg-white border border-gray-200 rounded-lg hover:bg-gray-100">
